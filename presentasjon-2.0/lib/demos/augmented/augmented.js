(function () {
    ...
    function startAugmentation(opts) {
        if (augmentationInit) {
            if (!augmented.running) {
                augmented.running = true;
                animate();
            }
...
// background color if no video present
        ...
        button1.src = "lib/demos/augmented/SquareRed.png";
        var buttonData1 = { name: "red", image: button1, x: 10, y: 10, w: 32, h: 32 };
        buttons.push(buttonData1);

        var button3 = new Image();
        button3.src = "lib/demos/augmented/SquareBlue.png";
...
// check if white region from blend overlaps area of interest (e.g. triggers)
        function checkAreas() {
            for (var b = 0; b < buttons.length; b++) {
                ...
                {
                    if (typeof opts[buttons[b].name] == 'function') {
                        opts[buttons[b].name]();
                    }
